...
- [Quick Start](#quick-start)
  - [Create — Start from a Description](#-create--start-from-a-description)
  - [Analyze — Scan Your Existing Project](#-analyze--scan-your-existing-project)
  - [Templates — Install Pre-Built Configs](#-templates--install-pre-built-configs)
  - [What Gets Created](#what-gets-created)
- [Usage Examples](#usage-examples)
  - [Writing Better Descriptions](#writing-better-descriptions)
  - [Analyze Strategies](#analyze-strategies)
...
The description you provide drives the entire generation. The quality of your description affects the output — here are examples from simple to detailed:
...
No description needed for analyze mode — the tool scans your codebase automatically. Just choose a strategy:
...
Contributions are welcome! Please open an issue or submit a pull request on [GitHub](https://github.com/microsoft/agent-forge).
